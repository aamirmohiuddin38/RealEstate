...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2022 at 06:06 PM
...
CREATE TABLE `property_tbl` (
  ...
  `p_country` varchar(30) NOT NULL COMMENT 'Country',
  `p_state` varchar(30) NOT NULL COMMENT 'State',
  `p_city` varchar(30) NOT NULL COMMENT 'City',
  `p_address` varchar(30) NOT NULL COMMENT 'Address',
  `p_postal_code` int(11) NOT NULL COMMENT 'Postal Code',
  ...
  `p_front_facing` varchar(20) NOT NULL,
...
INSERT INTO `property_tbl` (`p_id`, `p_title`, `p_content`, `p_type`, `p_label`, `p_status`, `p_country`, `p_state`, `p_city`, `p_address`, `p_postal_code`, `p_bathrooms`, `p_bedrooms`, `p_area`, `p_area_unit`, `p_land`, `p_land_unit`, `p_garage`, `p_garages_unit`, `p_year`, `p_price`, `p_front_facing`, `p_private_note`, `p_featured`, `p_published`, `p_doc`, `p_dou`) VALUES
(39, 'Ashiyana', 'dsgdg', '3', '1', '2', '3', '3', '3', 'Lal chowk', 190020, 4, 3, 30000, '3000', 1000, '1000', 2, '2000', 2015, '150000', '2', '', 1, 1, '2022-03-12 17:03:32', '0000-00-00 00:00:00');

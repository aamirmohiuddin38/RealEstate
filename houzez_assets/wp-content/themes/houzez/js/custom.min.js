...
!(function ($) {
	...
	var $win = $(window),
		...
		ajaxurlenquiry = houzez_vars.enquiry_url,
		...
		input_search_price_range_min = parseInt(
			houzez_vars.input_search_min_price_range
		),
		input_search_price_range_max = parseInt(
			houzez_vars.input_search_max_price_range
		),
	...
	function mortgage_calucaltion_section(e, a, t, r, o, s, i) {
		...
		(v = currencyFormate(v)),
			$("#principal_interest_val").html(h),
			$("#property_tax_val").html(_),
	...
	var price_range_search = function (
		e,
		a,
		input_search_price_range_min,
		input_search_price_range_max
	) {
		if (
			($(".price-range").slider({
				range: !0,
				min: e,
				max: a,
				values: [input_search_price_range_min, input_search_price_range_max],
				slide: function (e, a) {
	...
	if ($(".price-range").length > 0 && 1 != is_halfmap) {
		...
		selected_status_adv_search == for_rent_price_slider
			...
			// This code is related to change the status of the property to display the price range
				...
				$.ajax({
					...
					success: function (e) {
						e.success
							? ($form
									.find(
										'input[name="first_name"], input[name="last_name"], input[name="f_phone"], input[name="email"], input[name="f_subject"]'
									)
									.val(""),
	...
	var setTopBannerFullScreen = function () {
		...
		header_area.hasClass("header-transparent-wrap")
			? (s.length && (a = s.outerHeight()), (t = getWindowHeight() - (a + i)))
			: (header_area.length &&

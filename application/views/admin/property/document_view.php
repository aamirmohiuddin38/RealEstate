...
<div class="card">
	...
	<div class="card-body">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<form action="<?php echo base_url('index.php/admin/property/document_upload'); ?>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="type">Property Title</label> <i class="req text-danger"> *</i>
							<select name="property_type" class="form-control" id="type">
				...
				<div class="col-md-3 form-group text-black">
					<label for="title">Document Name</label><i class="req text-danger"> *</i>
					<input type="text" id="title" class="form-control" placeholder="property title" name="pd_title" value="">
					<span class="badge badge-danger">
						<?php echo form_error('pd_title');
						?>
					</span>
				</div>
			...
			<div class="card-body">
				<div class="d-flex">
					<div class="form-group w-75">
						<form action="<?php echo base_url('index.php/admin/property/document_list'); ?>" method="post">
							<label for="type">Property Title</label> <i class="req text-danger"> *</i>
							...
							if (!empty($list)) {
								...
								foreach ($list as $val1) { ?>
									<tr>
										...
										if (!empty($type)) {
											foreach ($type as $tp) {
												if ($tp['p_id'] == $val1['pd_p_id']) {
										?>
													<td><?php echo $tp['p_title'];
														}
													}
												} ?></td>
													<td> <?php echo $val1['pd_title']; ?></td>
													<td class="text-center">
														<a href="<?php echo base_url(); ?>index.php/admin/property/document_delete?id=<?php echo $val1['pd_id']; ?>"> <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
														<a href="<?php echo base_url(); ?>index.php/admin/property/document_download?path=<?php echo $val1['pd_file_path']; ?>"> <button type="button" class="btn btn-success btn-sm"><i class="fa fa-download"></i></button></a>

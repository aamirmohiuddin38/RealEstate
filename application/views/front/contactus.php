<link rel='stylesheet' id='elementor-post-16753-css' href='<?php echo base_url('houzez_assets/'); ?>wp-content/uploads/elementor/css/post-16941.css' type='text/css' media='all' />
<section class="content-wrap">
  <div data-elementor-type="wp-page" data-elementor-id="16941" class="elementor elementor-16941" data-elementor-settings="[]">
    <div class="elementor-inner">
      <div class="elementor-section-wrap">
        <section class="elementor-section elementor-top-section elementor-element elementor-element-125aa3d elementor-section-height-min-height animated-slow elementor-section-boxed elementor-section-height-default elementor-section-items-middle animated fadeIn" data-id="125aa3d" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;animation&quot;:&quot;fadeIn&quot;}">
                  ...
                  <div class="elementor-widget-wrap">
                    <div class="elementor-element elementor-element-8ff1404 elementor-widget elementor-widget-text-editor" data-id="8ff1404" data-element_type="widget" data-widget_type="text-editor.default">
                      <div class="elementor-widget-container">
                        <div class="elementor-text-editor elementor-clearfix">
                          <p>Write your quries and we will reach you as soon as possible.</p>
                        </div>
                      </div>
                    </div>
                    <div class="elementor-element elementor-element-f4a5b85 elementor-button-align-stretch elementor-widget elementor-widget-houzez_elementor_contact_form" data-id="f4a5b85" data-element_type="widget" data-widget_type="houzez_elementor_contact_form.default">
                      <div class="elementor-widget-container">
                        ...
                        <form class="elementor-form" id="houzez-form-f4a5b85" method="post" name="New Form" action="<?php echo base_url('houzez/save_message'); ?>" novalidate="novalidate">
                          <div class="elementor-form-fields-wrapper elementor-labels-above">
                            ...
                            <div class="elementor-field-group elementor-column form-group elementor-field-group-name elementor-col-50 elementor-field-required elementor-mark-required">
                              <label for="form-field-name" class="elementor-field-label">First Name</label><input type="text" name="first_name" id="form-field-name" class="elementor-field form-control elementor-size-sm elementor-field-textual" placeholder="Enter your name" title="* First Name" required="required">
                            </div>
                            ...
                            <div class="elementor-field-group elementor-column form-group elementor-field-group-bf18955 elementor-col-50 elementor-field-required elementor-mark-required">
                              <label for="form-field-bf18955" class="elementor-field-label">Last Name</label><input type="text" name="last_name" id="form-field-bf18955" class="elementor-field form-control elementor-size-sm elementor-field-textual" placeholder="Enter your last name" title="* Last Name" required="required">
                            </div>

                            <div class="elementor-field-group elementor-column form-group elementor-field-group-bf189551 elementor-col-50 elementor-field-required elementor-mark-required">
                              <label for="form-field-bf189551" class="elementor-field-label">Phone Number</label><input type="text" name="f_phone" id="form-field-bf189551" class="elementor-field form-control elementor-size-sm elementor-field-textual" placeholder="Enter your last name" title="* Phone Number" required="required">
                            </div>
                            ...
                            <div class="elementor-field-group elementor-column form-group elementor-field-group-email elementor-col-50 elementor-field-required elementor-mark-required">
                              <label for="form-field-email" class="elementor-field-label">Email</label><input type="email" name="email" id="form-field-email" class="elementor-field form-control elementor-size-sm elementor-field-textual" placeholder="Enter your Email" title="* Email" required="required">
                            </div>

                            <div class="elementor-field-group elementor-column form-group elementor-field-group-bf189552 elementor-col-100 elementor-field-required elementor-mark-required">
                              <label for="form-field-bf189552" class="elementor-field-label">Subject</label><input type="text" name="f_subject" id="form-field-bf189552" class="elementor-field form-control elementor-size-sm elementor-field-textual" placeholder="Enter your subject" title="* Subject" required="required">
                            </div>
                            ...
                            <div class="elementor-field-group elementor-column form-group elementor-field-group-message elementor-col-100 elementor-field-required elementor-mark-required">
                              <label for="form-field-message" class="elementor-field-label">Message</label><textarea class="elementor-field-textual elementor-field elementor-size-sm" name="message" id="form-field-message" rows="4" placeholder="Message" required="required" title="* Message"></textarea>
                            </div>

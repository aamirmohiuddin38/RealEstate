        ...
        <div class="col-md-7 col-lg-5">
          <div class="wrap">
            ...
            <div class="login-wrap p-4 p-md-5">
              ...
              <form action="<?php echo base_url('index.php/login/checklogin'); ?>" class="signin-form" method="POST">
                <div class="form-group mt-3">
                  <input type="text" class="form-control" name="email" required>
                  <label class="form-control-placeholder" for="email">Email</label>
                </div>
                <div class="form-group">
                  <input id="password-field" type="password" class="form-control" name="pswd" required>
              ...
              <p class="text-center">Not a member? <a data-toggle="tab" href="<?php echo base_url('index.php/login/register'); ?>">Sign Up</a></p>
            </div>
          </div>
        </div>
      </div>

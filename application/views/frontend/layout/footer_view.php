...
<!-- Footer -->
<footer class="text-center text-lg-start main-footer">
<!-- Section: Social media -->
<section
    class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom" style="color:#fff;">
    <!-- Left -->
...
<section class=""  style="color:#fff;">
    ...
    <div class="row mt-3 middle-footer">
        ...
        <p><i class="fas fa-home me-3"></i> University of Kashmir, Srinagar</p>
        <p>
            <i class="fas fa-envelope me-3"></i>
            homesphere@gmail.com
        </p>
...
<div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05); color:#fff;">
    © 2021 Copyright:
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">homesphere@gmail.com</a>
</div>
<!-- Copyright -->
</footer>
<!-- Footer -->
...
<script type = 'text/javascript' src = "<?php echo base_url(); ?>assets/js/slick.min.js"></script> <!-- Slick JS -->

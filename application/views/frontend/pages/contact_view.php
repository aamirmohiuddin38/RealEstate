    ...
    <form>
      <div class="row">
        <div class="form-group col-md-6">
          <label for="FirstName">FirstName</label><small class="req text-danger"> *</small>
          <input type="text" class="form-control" id="inputEmail4" placeholder="FirstName" required>
        </div>
        <div class="form-group col-md-6">
          <label for="LastName">LastName</label><small class="req text-danger"> *</small>
      ...
      <div class="row ">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="inputEmail4" placeholder="Phone No" required>
        </div>
        <div class="form-group col-md-6">
